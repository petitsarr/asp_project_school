<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SupprimerTest.aspx.vb" Inherits="APPCOVID19.SupprimerTest" %>
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style2">
                    <asp:TextBox ID="txtNumero" runat="server" style="margin-left: 0px"></asp:TextBox>
